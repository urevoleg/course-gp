...
Создавали таблицы в разных схема, меняли `search_path` и смотрели как себя ведут запросы на чтение из разных таблиц.
...
Лучшее соотношение: zstd\zlib пр степен сжатия 1-2, rle_type сжатие 2
